...
Select Location, date,population, total_cases,total_deaths,(total_deaths/total_cases)*100 as InfectedDeathPercentage
From PortfolioProject..CovidDeaths
...
-- Countries with Highest Death Count per Population and PercentPopulationDead
